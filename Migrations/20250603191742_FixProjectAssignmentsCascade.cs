...
{
    /// <inheritdoc />
    public partial class FixProjectAssignmentsCascade : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkloadStatus = table.Column<int>(type: "int", nullable: false),
                    NumberOfActiveProjects = table.Column<int>(type: "int", nullable: false),
                    NumberOfTasks = table.Column<int>(type: "int", nullable: false),
                    EstimatedHours = table.Column<int>(type: "int", nullable: false),
                    NextProjectDeadline = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfPeopleNeeded = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EmployeeProfileUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectAssignments_EmployeeProfiles_EmployeeProfileUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "7da7bd79-6448-49cd-936e-8842d5c94501", new DateTime(2025, 6, 3, 19, 17, 42, 199, DateTimeKind.Utc).AddTicks(2154), "Project Manager role with full access", "Manager", "MANAGER" },
                    { "2", "b5eda1ea-2085-4347-9e0f-9ba9883dca82", new DateTime(2025, 6, 3, 19, 17, 42, 199, DateTimeKind.Utc).AddTicks(2231), "Team Lead role with team management access", "TeamLead", "TEAMLEAD" },
                    { "3", "1049c57c-ab90-4b93-b165-40d9d0590d0a", new DateTime(2025, 6, 3, 19, 17, 42, 199, DateTimeKind.Utc).AddTicks(2240), "Employee role with basic access", "Employee", "EMPLOYEE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignments_EmployeeProfileUserId",
                table: "ProjectAssignments",
